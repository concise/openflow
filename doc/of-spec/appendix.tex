...
As neighbor as discovered or expired, the controller needs to be informed via the \verb|OFPT_NEIGHBOR_MSG| message:

\input{struct/ofp_neighbor_msg}
The \verb|activity| is an enumeration that indicates if a new neighbor is found or an old neighbor has expired.

\input{enum/ofp_neighbor_activity} 
