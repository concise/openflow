...
\\\\
The \verb|datapath_name| field is a human-readable identifier for a datapath.  There is no requirement that it be unique, however it is most useful when it is.
\\\\
