...
The switch replies back with a  ofp\_queue\_get\_config\_reply command, containing
...
ofp\_queue is the structure that fully describes a queue:
\input{struct/ofp_queue}

Currently, there is only a minimum-rate type queue, described by the
ofp\_queue\_prop\_min\_rate structure :
