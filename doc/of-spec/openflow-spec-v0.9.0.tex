...
An OpenFlow-enabled switch must supports neighbor discovery via a custom Link Layer Discovery Protocol (LLDP).  This will be the default mechanism for link discovery between OpenFlow switches.  This mechanism involves sending of LLDP packets/probes to discover new neighbor and/or its absence via expiry.  Alternative mechanisms to replace this default should ideally be user configurable, but is beyond the scope of this specification.
